...
| MOD-04 | Employee/account administration | `AdminPage.tsx`, `manage-employee`, profile migrations | Critical | In progress — BUG-068 fixed locally; Edge deployment pending; production currently 37/37 synchronized |

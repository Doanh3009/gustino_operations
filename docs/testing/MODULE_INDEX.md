...
| MOD-13 | Daily shift report/finalization/archive | `ReportPage.tsx`, `ReportArchivePage.tsx`, `lib/reportSync.ts`, `lib/reportDeliveryIntent.ts`, report APIs/RPCs | Critical | In progress — owner-defined Ca 1/Ca 2 close semantics and the pending Zalo-intent seam pass focused/report regressions locally; external connection, UI and first midnight cron verification pending |

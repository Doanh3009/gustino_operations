...
| MOD-20 | Frontend load performance and perceived responsiveness | `App.tsx`, lazy-route recovery, `GlobalLoadingOverlay.tsx`, management/attendance/orders pages, export helpers | High | In progress — lazy/loading guards plus BUG-105 mobile Orders layout pass locally; production/UI verification pending |

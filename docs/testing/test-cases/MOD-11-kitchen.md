...
| MOD11-TC-HISTORY-01 | Kitchen reviews current and historical requests | Every card shows order date and desired receiving schedule; history filters by status, desired date, morning/noon/afternoon and free text without hiding legacy orders | Pre-fix delivery/history contract failed; implementation active |

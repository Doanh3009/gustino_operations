...
- In-app Browser retry on 2026-07-20: setup/troubleshooting succeeded but discovery again returned `[]`, meaning no browser window is attached to the current session. Physical phone/signed-in viewport tests remain pending.

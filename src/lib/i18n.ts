...
const EN_TEXT: Record<keyof typeof VI_TEXT, string> = {
  ...
  kitchenPending: 'Waiting for kitchen',
  kitchenWorking: 'In progress',
  kitchenDone: 'Done',
  ...
  kitchenNoWorking: 'No orders in progress.',
  kitchenNoDone: 'No completed orders.',
  kitchenAccept: 'Accept order',
  kitchenFinish: 'Complete',
  kitchenSaving: 'Saving...',
  kitchenAcceptedFeedback: 'Kitchen accepted the order.',
  kitchenFinishedFeedback: 'Order completed.',
